...
app_ui <- function(request) {
  ...
  shiny::navbarPage(id = "navbar",  
                    ...
                    shiny::tabPanel("Animal Tracking",
                                    shiny::tabsetPanel(id = 'AT', type = "pills",
                                                       shiny::tabPanel(value = "atspat", "Spatial", mod_ATSpatial_ui("ATSpatial_1")),
                                                       shiny::tabPanel(value = "atstats", "Statistics", mod_ATStats_ui("ATStats_1")),
                                                       shiny::tabPanel(value = "atcs", "CaseStudies", mod_ATCases_ui("ATCases_1")),
                                    )),
