                           ...
                           shiny::fluidRow(
                             column(3,
                                    ...
                                    shiny::fluidRow(
                                      shiny::column(6,
                                                    style = "padding:0px;",
                                                    div(a(img(src = "www/AODN_logo.png", width = "92%"),
                                                          href = "https://portal.aodn.org.au", target = "_blank"),
                                                        style = "text-align: center;")),
                                      shiny::column(6,
